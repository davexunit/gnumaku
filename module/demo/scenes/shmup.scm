...
(define-coroutine (player-shot-1 player)
  (when (shooting player)
    ...
    (let ((x (x player))
      ...
      (emit-simple-bullet bullets (- x 16) y speed 269 'sword)
      (emit-simple-bullet bullets x (- y 20) speed 270 'sword)
      (emit-simple-bullet bullets (+ x 16) y speed 271 'sword))
    (wait player 3)
