...
(define (make-particles)
  (let ((particles (make-particle-system 200 (load-asset "particle.png" 256 256 0 0))))
    ...
    (set-particle-start-color particles (make-color-f .5 .1 .02 .9))
    (set-particle-start-color-var particles (make-color-f .3 .1 0 0))
    (set-particle-end-color particles (make-color-f .8 0 0 1))
    (set-particle-end-color-var particles (make-color-f .2 0 0 0))
    particles))
