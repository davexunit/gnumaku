            ...
            "Return a new rectangle translated by @var{delta} units.")
{
    ...
    return gmk_scm_from_rect (gmk_rect_move (gmk_scm_to_rect (rect), v));
}
            ...
            "Center rectangle at @var{position}.")
{
    ...
    return gmk_scm_from_rect (gmk_rect_center (gmk_scm_to_rect (rect), v));
}
            ...
            "Return @code{#t} if @var{point} is within @var{rect}.")
{
    ...
    return scm_from_bool (gmk_rect_collide_point (gmk_scm_to_rect (rect), v));
}
